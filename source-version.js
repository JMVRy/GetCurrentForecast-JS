(async () => {
	...
	(data) => {
		...
		if (currentForecast["detailedForecast"] == "" || currentForecast["detailedForecast"] == null) {
			alert(currentForecast["shortForecast"] + " at " + currentForecast["temperature"] + "°" + currentForecast["temperatureUnit"] + ". " + currentForecast["windDirection"] + " winds at " + currentForecast["windSpeed"] + ".");
		} else {
